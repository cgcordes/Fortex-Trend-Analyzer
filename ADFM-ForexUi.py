        ...
        with st.spinner(f"Analyzing {currency_pair}..."):
            ...
            if df.empty:
                ...
                with tab3:
                    ...
                    fig_ind.add_trace(go.Scatter(x=df.index, y=df["BB_upper"], name="BB Upper"))
                    fig_ind.add_trace(go.Scatter(x=df.index, y=df["BB_middle"], name="BB Middle"))
                    fig_ind.add_trace(go.Scatter(x=df.index, y=df["BB_lower"], name="BB Lower"))
                    st.plotly_chart(fig_ind, use_container_width=True)

                    # Latest values
                    latest = df[["SMA_20","SMA_50","BB_upper","BB_lower","RSI"]].iloc[-1]
                ...
                with tab4:
                    ...
                    st.download_button(
                        ...
                        data=csv,
                        file_name=f"{currency_pair.replace('/','')}_{selected_interval}.csv",
                        mime="text/csv"
                    )
